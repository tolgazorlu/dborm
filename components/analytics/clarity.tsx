 ...
 *
 * İstemci bileşeni olmasının tek sebebi adres yolunu görebilmek: paylaşım
 * linkinin token'ı URL'de duruyor ve Clarity sayfa adreslerini kaydediyor.
 * `/s/...` sayfalarında analitiği hiç yüklemezsek token üçüncü tarafa gitmez.
 */
